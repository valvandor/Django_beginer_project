    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_birthday', models.DateField(default=datetime.datetime(2003, 10, 4, 17, 24, 55, 4571, tzinfo=utc), verbose_name='дата рождения')),
                ('first_name', models.CharField(max_length=150, verbose_name='имя')),
                ('last_name', models.CharField(max_length=150, verbose_name='фамилия')),
                ('email', models.EmailField(max_length=254, verbose_name='email address')),
                ('activation_key', models.CharField(blank=True, max_length=128)),
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2021, 10, 6, 17, 24, 55, 4743, tzinfo=utc))),
